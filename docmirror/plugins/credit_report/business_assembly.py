...
_COLLECTION_ID_KEYS = {
    ...
    "repayment_liability_records": "liability_id",
...
_NORMALIZED_FIELDS: dict[str, tuple[tuple[str, tuple[str, ...]], ...]] = {
    "credit_accounts": (
        ...
        ("balance", ("balance",)),
        ("snapshot_date", ("snapshot_date", "information_as_of")),
        ...
        ("recent_6_month_average_used_amount", ("recent_6_month_average_used_amount",)),
        ("maximum_used_amount", ("maximum_used_amount",)),
        (
            "recent_6_month_average_overdraft_balance",
            ("recent_6_month_average_overdraft_balance",),
        ),
        ("maximum_overdraft_balance", ("maximum_overdraft_balance",)),
        ("unbilled_installment_balance", ("unbilled_installment_balance",)),
    ...
    "repayment_liability_records": (
        ...
        ("sequence", ("sequence",)),
        ("account_identifier", ("account_identifier",)),
        ("liability_date", ("liability_date", "responsibility_date")),
        ("open_date", ("open_date",)),
        ("due_date", ("due_date",)),
        ("related_party_name", ("related_party_name",)),
        ("related_party_id_type", ("related_party_id_type",)),
        ...
        ("responsibility_amount_status", ("responsibility_amount_status",)),
        ("contract_number", ("contract_number",)),
        ("contract_number_status", ("contract_number_status",)),
