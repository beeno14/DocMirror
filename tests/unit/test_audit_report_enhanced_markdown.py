...
def test_generic_plugin_uses_audit_bundle_only_for_audit_report() -> None:
    ...
    audit_bundle = plugin.project_bundle(seal_parse_result(result("audit_report")), file_path="audit.pdf")
